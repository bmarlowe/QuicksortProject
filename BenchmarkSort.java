...
class BenchmarkSorts {
    ...
    void runSorts() throws UnsortedException {
        ...
        for (int i = 0; i < dataSize.length; i++) {
            ...
            for (int setNum = 0; setNum < numOfDataSets; setNum++) {
                ...
                quickSort.iterativeSort(iterativeData);
                iterativeCountData[setNum] = quickSort.getCount();
                iterativeTimeData[setNum] = quickSort.getTime();

                quickSort.recursiveSort(recursiveData);
                recursiveCountData[setNum] = quickSort.getCount();
                recursiveTimeData[setNum] = quickSort.getTime();
            }
    ...
    void displayReport() {
        ...
        System.out.println();
        System.out.format("%13s %50s %50s", "\t  |", "\t  Iterative", "\t  Recursive");
        System.out.println();
